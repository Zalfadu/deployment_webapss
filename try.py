...
with st.sidebar:
        option = st.radio('Pilih salah satu:',['Pendahuluan','KALKON','KANGEN','Durasi Paparan Kimia'])
if option == "Pendahuluan": 
    st.image('https://i.pinimg.com/originals/de/75/fa/de75fa1895ee5b97edaf8a50d98eaba9.jpg')
    st.header("Website Perhitungan Konsentrasi dan Durasi Paparan Bahan Kimia Oleh Kelompok 7")
...
if option == "Durasi Paparan Kimia": 
    #Write
    st.header('Durasi Paparan Bahan Kimia🧪')
